...
first_warehouse = all_warehouse - second_and_third
third_warehouse = all_warehouse - first_and_second
second_warehouse = (first_warehouse + third_warehouse) - all_warehouse
...
print(round(total_gas_station_stop))
